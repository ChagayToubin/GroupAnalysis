...
class DAL:
    def __init__(self):
        ...
        self.classify_categories = ["Terrorism","financial","sexual","leisure"]
    ...
    def dal(self,group_name):
        ...
        for category in self.classify_categories:
            ...
            for type in self.types:
                my_dict[category][type] = self.mycol.count_documents({"metadata.group_link":group_name,"metadata.category":type,"metadata.classification":category})
